...
class FakeDataController extends AbstractController
{
    ...
    public function index(ManagerRegistry $doctrine): Response
    {
        ...
        // on ajoute des données dans notre Application
        ...
        // 3 étapes pour ajouter en BDD
        // $newObject = new Post();
        // $newObject->set...
        // $em->persist($newObject);
        // $em->flush();

        // dire à doctrine d'écrire en BDD
        $entityManager->flush();
    ...
    /**
     * @Route("/fake/random", name="fake_random")
     */
    public function randomData(ManagerRegistry $doctrine): Response
    {
        ...
        // créer une liste de movie et les stocker dans un tableau
